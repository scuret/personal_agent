...
def main() -> None:
    ...
    print()
    print("  ⚠ A guided web wizard at http://127.0.0.1:8780/wizard is the")
    print("  recommended path for first-time setup. It walks you through")
    print("  every step in a browser, with provider-specific screenshots")
    print("  and verify buttons. Run `./install.sh` once to install Python")
    print("  deps + LaunchAgents, then visit /wizard in your browser.")
    print()
    print("  This CLI configurator still works for power users who prefer")
    print("  terminal prompts. Existing values are preserved unless you")
    print("  change them; empty input = keep current.")
    print()
